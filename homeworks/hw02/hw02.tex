...
\hardsubproblem{Bob is the alleged father and he has blood type B but his genotype is unknown. What is the probability he passes on a B to the child? Hint: it is the same as (a) except now you only consider the genotypes that can produce the blood type B.}\spc{3}
